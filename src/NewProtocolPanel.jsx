  ...
  return (
    <fieldset>
        ...
        {["Balanced", "Alternating"].map((alg) => (
          <span key={alg}>
            <input
              ...
              onChange={(e) =>
                dispatch({ type: "changed", field: "algorithm", value: alg })
              }
            />
      ...
      <fieldset>
        ...
        {specs.groupNames.map((grp, i) => (
          <p key={i}>
            ...
            {specs.groupNames.length > 2 && (
              <button
                onClick={(e) => dispatch({ type: "removeGroup", index: i })}
              >
                Remove Group
              </button>
            )}
        ...
        <button onClick={(e) => dispatch({ type: "addGroup" })}>
          Add Another Group
        </button>
      </fieldset>
      <div>
          ...
          <fieldset key={i}>
            ...
            {v.type == "categorical" && (
              <fieldset>
                ...
                <button
                  onClick={(e) =>
                    dispatch({ type: "addLevel", variableIndex: i })
                  }
                >
                  {" "}
                  Add Level{" "}
            ...
            {specs.variableSpec.length > 1 && (
              <button
                onClick={(e) =>
                  dispatch({ type: "removeVariable", variableIndex: i })
                }
              >
                Remove Variable
              </button>
        ...
        <button onClick={(e) => dispatch({ type: "addVariable" })}>
          Add Another Variable
        </button>
      </div>
      {!errorMessage && <button onClick={startProtocol}>Start</button>}
